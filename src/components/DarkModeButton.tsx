...
const IconDark = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="w-[24px] h-[24px]">
    <path
...
const IconLight = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="w-[24px] h-[24px]">
    <title />
    <circle cx="12" cy="12" fill="rgb(72, 72, 72)" r="5" />
    <path d="M21,13H20a1,1,0,0,1,0-2h1a1,1,0,0,1,0,2Z" fill="rgb(72, 72, 72)" />
    <path d="M4,13H3a1,1,0,0,1,0-2H4a1,1,0,0,1,0,2Z" fill="rgb(72, 72, 72)" />
    <path
